...
pub struct Text {
    ...
    pub mtc_from: &'static str,
    pub mtc_in_note: &'static str,
    pub mtc: &'static str,
    pub mtc_send: &'static str,
    pub mtc_badge: &'static str,
    pub mtc_needs_a_port: &'static str,
    pub mtc_sending: &'static str,
    pub mtc_died: &'static str,
    pub mtc_stopped: &'static str,
    pub mtc_note: &'static str,
    ...
    pub rtp_port_prefix: &'static str,
    pub rtp_port_tooltip: &'static str,
    pub rtp_peer_hint: &'static str,
    pub rtp_waiting: &'static str,
    pub rtp_no_journal: &'static str,
    pub file: &'static str,
    pub load: &'static str,
    ...
    pub unnamed_cue: &'static str,
    pub from_a_preset: &'static str,
    pub preset_added: &'static str,
    pub port_unconfirmed: &'static str,
...
pub static ENGLISH: Text = Text {
    ...
    rescan: "Look again",
    mtc_from: "MIDI in",
    mtc_in_note: "Chases a DAW or a desk over MIDI instead of a sound card. Positions arrive every two frames, which is what MTC gives — the counting in between is the same as when LTC drops out. There is no \"stopped\" message in MTC: silence is how it says so.",
    mtc: "MTC out",
    mtc_send: "Send MTC",
    mtc_badge: "MTC",
    mtc_needs_a_port: "pick a MIDI port above first —",
    mtc_sending: "sending MTC out of {}",
    mtc_died: "{} stopped taking MTC — unplugged?",
    mtc_stopped: "MTC stopped",
    mtc_note: "Sends the timecode being chased back out as MIDI Time Code, on the port chosen above. Two frames of latency are built into the format and cannot be removed, which is why an MTC-locked machine always sits a frame or two behind an LTC-locked one.",
    ...
    rtp_note: "Chasefire speaks the protocol itself: nothing to install, and no driver for somebody else's update to break the week of a show.",
    rtp_port_prefix: "port ",
    rtp_port_tooltip: "This end listens here and on the port after it. 5004 is what everything in this trade defaults to.",
    rtp_peer_hint: "address:port, or leave empty to be invited",
    rtp_waiting: "waiting to be invited on {}",
    rtp_no_journal: "No recovery journal: it rebuilds lost notes after the fact, and a cue reconstructed thirty seconds late is worse than one that went missing.",
    file: "File",
    load: "Load",
    save_to_file: "Save",
    new_list: "New",
    ...
    add_cue: "Add cue",
    unnamed_cue: "cue {}",
    from_a_preset: "From a preset…",
    preset_added: "{} cue added — set its time",
    port_unconfirmed: "the port for this one could not be confirmed from the manufacturer's own documentation; check it on the desk",
    remove: "remove",
    ...
    art_by: "Art by",
    art_by_value: "Claude, to Leo Bolster's brief and corrections",
    licence: "Licence",
...
pub static SPANISH: Text = Text {
    ...
    mtc_from: "Entrada MIDI",
    mtc_in_note: "Sigue a un DAW o a una mesa por MIDI en vez de por tarjeta de sonido. Las posiciones llegan cada dos frames, que es lo que da MTC — contar entre medias es lo mismo que hace cuando se cae el LTC. En MTC no hay mensaje de «parado»: el silencio es la forma de decirlo.",
    mtc: "Salida MTC",
    mtc_send: "Mandar MTC",
    mtc_badge: "MTC",
    mtc_needs_a_port: "elige antes un puerto MIDI arriba —",
    mtc_sending: "mandando MTC por {}",
    mtc_died: "{} ha dejado de aceptar MTC — ¿desenchufado?",
    mtc_stopped: "MTC parado",
    mtc_note: "Manda el timecode que estamos siguiendo otra vez hacia fuera como MIDI Time Code, por el puerto elegido arriba. El formato lleva dos frames de retardo de fábrica y no se pueden quitar: por eso una máquina enganchada a MTC va siempre un frame o dos por detrás de una enganchada a LTC.",
    ...
    rtp_note: "Chasefire habla el protocolo por sí mismo: nada que instalar, y ningún driver que la actualización de otro pueda romper la semana del bolo.",
    rtp_port_prefix: "puerto ",
    rtp_port_tooltip: "Este extremo escucha aquí y en el puerto siguiente. 5004 es lo que usa por defecto todo el gremio.",
    rtp_peer_hint: "dirección:puerto, o vacío para que te inviten",
    rtp_waiting: "esperando invitación en {}",
    rtp_no_journal: "Sin recovery journal: reconstruye notas perdidas a posteriori, y una cue reconstruida treinta segundos tarde es peor que una que no llegó.",
    file: "Fichero",
    load: "Cargar",
    ...
    add_cue: "Añadir cue",
    unnamed_cue: "cue {}",
    from_a_preset: "De un preset…",
    preset_added: "cue de {} añadida — ponle la hora",
    port_unconfirmed: "el puerto de este no se pudo confirmar en la documentación del fabricante; compruébalo en la consola",
    remove: "quitar",
    ...
    art_by: "Dibujos de",
    art_by_value: "Claude, con guion y correcciones de Leo Bolster",
    licence: "Licencia",
