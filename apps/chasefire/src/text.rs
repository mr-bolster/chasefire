...
pub static ENGLISH: Text = Text {
    ...
    column_sends: "sends",
    column_value: "value",
    value_tooltip: "The value sent with the address. For Resolume, 1 triggers and 0 releases; for something like a fader it would be the level.",
    ...
    donate: "Donate",
    downloads: "downloads and everything else",
    version: "Version",
...
pub static SPANISH: Text = Text {
    ...
    file: "Fichero",
    load: "Cargar",
    save_to_file: "Guardar al fichero",
    add_cue: "Añadir cue",
    remove: "quitar",
    ...
    column_sends: "envía",
    column_value: "valor",
    value_tooltip: "El valor que acompaña a la dirección. Resolume entiende 1 como «dispara» y 0 como «suelta»; en un fader sería el nivel.",
    ...
    donate: "Donar",
    downloads: "descargas y todo lo demás",
    version: "Versión",
